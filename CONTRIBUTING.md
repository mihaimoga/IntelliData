...
***Ask not what IntelliData can do for you - ask what you can do for IntelliData***
...
2. Include additional information such as:
    ...
    * IntelliData Debug-Info containing:
...
1. Respect existing IntelliData coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
