...
// IntelliData.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CIntelliDataApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CIntelliDataApp::OnAppAbout)
...
CIntelliDataApp::CIntelliDataApp() noexcept : m_pInstanceChecker(_T("IntelliData"))
{
	...
	SetAppID(_T("IntelliData.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CIntelliDataApp object

CIntelliDataApp theApp;


// CIntelliDataApp initialization

BOOL CIntelliDataApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_IntelliDataTYPE,
		RUNTIME_CLASS(CIntelliDataDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CIntelliDataView));
	if (!pDocTemplate)
		return FALSE;
...
int CIntelliDataApp::ExitInstance()
{
...
// CIntelliDataApp message handlers
...
void CIntelliDataApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CIntelliDataApp customization load/save methods

void CIntelliDataApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CIntelliDataApp::LoadCustomState()
{
}

void CIntelliDataApp::SaveCustomState()
{
}
